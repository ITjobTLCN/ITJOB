	...
	<div class="job-item">
		<div class="row" >
			...
			<div class="col-xs-12 col-sm-2 col-md-1 col-lg-2">
				@if(Auth::check())
				<div class="follow{{ $ljlt->_id }}" id="followJob" emp_id="{{ $ljlt->employer['_id'] }}" job_id="{{ $ljlt->_id }}">
					@if(app(App\Http\Controllers\JobsController::class)->getJobFollowed($ljlt->_id) == 1)
