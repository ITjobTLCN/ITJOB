								...
								<div class="row" >
									<div class="col-xs-12 col-sm-2 col-md-3 col-lg-2" >
										<div class="logo job-search__logo">
											<a href=""><img title="" class="img-responsive" src="assets/img/logo/{{$tjv->logo}}" alt="">
											</a>
										</div>
									</div>
									<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
										<div class="job-item-info" >
											...
											<div class="company">
												<span class="job-search__company">{{$tjv->en}}</span>
												<span class="separator">|</span>
												<span class="job-search__location">{{$tjv->cn}}</span>
											</div>
											<div class="description-job">
												<h3>{{$tjv->description}}</h3>
											</div>
											...
											<div style="margin-top: 10px;">
												@foreach(app(App\Http\Controllers\JobsController::class)->getListSkillJobv($tjv->id) as $sj)
